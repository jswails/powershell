...
if($result){
 ...
 $applog | select-object EventID, MachineName, EntryType, Message, Source, TimeGenerated, TimeWritten, Username | export-csv e:\wamp\www\eventlog\$mach.warn.application.csv -notypeinformation
 }
 } else {
