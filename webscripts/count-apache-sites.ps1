...
write-host " ##############################################################################"
      ...
      $index = gci '\\sadc1cmadmp1\e$\wamp\bin\apache\Apache2.4.4\logs\access.log' | select-string -Pattern "index.php"
...
write-host " ##############################################################################"
      ...
      $iamindex = gci '\\sadc1cmadmp1\e$\wamp\bin\apache\Apache2.4.4\logs\access.log' | select-string -Pattern "index.html"
 write-host " IAM Entry Page Site = " $iamindex.count

       $addadmin = gci '\\sadc1cmadmp1\e$\wamp\bin\apache\Apache2.4.4\logs\access.log' | select-string -Pattern "addlocaladmin.php"
 write-host "Add Local Admin page = " $addadmin.count

 
       $addad = gci '\\sadc1cmadmp1\e$\wamp\bin\apache\Apache2.4.4\logs\access.log' | select-string -Pattern "addtoworkstationadminAD.php"
 write-host " Add to workstation admin AD group = " $addad.count
  
       $chkadmin = gci '\\sadc1cmadmp1\e$\wamp\bin\apache\Apache2.4.4\logs\access.log' | select-string -Pattern "chklocaladmin.php"
 write-host " Check Local Admin Site = " $chkadmin.count
 
       $addsudo = gci '\\sadc1cmadmp1\e$\wamp\bin\apache\Apache2.4.4\logs\access.log' | select-string -Pattern "sudofile.php"
 write-host " Add to Sudo file = " $addsudo.count