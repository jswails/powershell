...
if($result){
 ...
 $seclog | select-object EventID, MachineName, EntryType, Message, Source, TimeGenerated, TimeWritten, Username | export-csv e:\wamp\www\eventlog\$mach.warn.security.csv -notypeinformation
 }
 } else {
