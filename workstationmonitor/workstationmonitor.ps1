...
PARAM([int]$Interval=30,[ScriptBlock]$ScriptBlock={(Get-wmiobject win32_service -filter "displayname = 'Symantec Endpoint Protection'" | select-object DisplayName,StartMode,State,Status);(Get-wmiobject win32_service -filter "displayname = 'SMS Agent Host'" | select-object DisplayName,StartMode,State,Status)
;(Get-wmiobject win32_service -filter "name = 'vpnagent'" | select-object DisplayName,StartMode,State,Status);(Get-wmiobject win32_service -filter "name = 'CVPND'" | select-object DisplayName,StartMode,State,Status);(Get-wmiobject win32_service -filter "name = 'ciscod.exe'" | select-object DisplayName,StartMode,State,Status);(Get-wmiobject win32_service -filter "name = 'nacagent'" | select-object DisplayName,StartMode,State,Status)
;(Get-wmiobject win32_service -filter "name = 'AppSense EmCoreService'" | select-object DisplayName,StartMode,State,Status)
;(Get-wmiobject win32_service -filter "name = 'AppSense Client Communications Agent'" | select-object DisplayName,StartMode,State,Status)
;(Get-wmiobject win32_service -filter "name = 'AppSense Application Manager Agent'" | select-object DisplayName,StartMode,State,Status)
;(Get-wmiobject win32_service -filter "name = 'AppSense Performance Manager Agent'" | select-object DisplayName,StartMode,State,Status)
})
...
$Form.text = "State Auto Workstation Check "   
...
$Command.Text = "StateAuto Workstation Check"
