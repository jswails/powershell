...
#mir = delete destination that no longer exist in source
...
robocopy $ENV:USERPROFILE\Documents $env:homeshare\Documents /MIR /XD "My Pictures" "My Music" "My Videos" "My Documents" /XF desktop.ini sync.ffs_db /FP /log+:c:\temp\sasync.log /R:2
...
robocopy $ENV:USERPROFILE\Favorites $env:homeshare\Favorites /MIR /XF desktop.ini sync.ffs_db /FP /log+:c:\temp\sasync.log /R:2
...
robocopy $ENV:USERPROFILE\Pictures $env:homeshare\Pictures /MIR /XF desktop.ini sync.ffs_db /FP /log+:c:\temp\sasync.log /R:2
...
robocopy $ENV:USERPROFILE\Desktop $env:homeshare\Desktop /MIR /XF desktop.ini sync.ffs_db /FP /log+:c:\temp\sasync.log /R:2
